...
const UpdateBlog = () => {
    ...
    const updateBlogHandler = async () => {
        ...
        try {
            setLoading(true)
            const res = await axios.put(`http://localhost:5001/api/v1/blog/${id}`, formData, {
                headers: {
    ...
    const togglePublishUnpublish = async (action) => {
        ...
        try {
            const res = await axios.patch(`http://localhost:5001/api/v1/blog/${id}`, {
                params: {
                    action
                },
                withCredentials: true
    ...
    const deleteBlog = async () => {
        try {
            const res = await axios.delete(`http://localhost:5001/api/v1/blog/delete/${id}`, { withCredentials: true })
            if (res.data.success) {
