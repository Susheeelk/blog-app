...
export const likeBlog = async (req, res) => {
    try {
        ...
        await blog.updateOne({ $addToSet: { likes: likeWalaUserId } })
        await blog.save()
